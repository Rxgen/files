   ...
   $sub_parent_menu_count =  $sub_parent_menu->count();
    if($sub_parent_menu_count > 0){
      foreach ($sub_parent_menu as $subParentKey => $subParentMenu) {
        ...
        $header_menu[$parentKey]['sub_parent'][$subParentKey]['content'] = $subParentMenu->content;
        $header_menu[$parentKey]['sub_parent'][$subParentKey]['description'] = $subParentMenu->description;
        $header_menu[$parentKey]['sub_parent'][$subParentKey]['image'] = $subParentMenu->image;
