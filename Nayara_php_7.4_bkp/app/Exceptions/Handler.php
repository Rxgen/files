...
class Handler extends ExceptionHandler
{
    ...
    public function render($request, Exception $exception)
    {
        if($this->isHttpException($exception)) {
           ...
           }elseif(is_a($exception, 'Symfony\Component\HttpKernel\Exception\MethodNotAllowedHttpException')) {
            
               return response()->view('exceptions.error', ['message'=>'Method Not Allowed', 'error_code'=>'405'], 405);
           }
			return redirect('/');
			//return response()->view('exceptions.error', ['message'=>'Sorry, the requested page could not be found', 'error_code'=>'404'], 404);
       }
