...
error_reporting(E_ALL);
		//$data = $conn->query("SELECT * FROM nayara_energy.retail_online_leads")->fetchAll();
		//print_r($data);exit;
		//$pumps = $db_ext->table('cms_RetailOutletDataWebsite');
		//$district = $db_ext->table('District_Mst')->where('StateId', $state)->get();
		$pst = $conn -> prepare("SELECT * FROM cms_RetailOutletDataWebsite");
		$pst -> execute();
		$red = $pst->fetchAll();
		print_r($red);
echo "hello1";exit;
...
echo "hello3";exit;
	...
	//[START] Added Campaign Code Start Here 28-Aug-2020
...
public function applyOnlineDealershipFormSubmit(Request $request){
    	...
    	$pst -> execute(array(null, null, null, $name, $contact, $email, 0, 0, null, null, null, null, null, null, $district, $state, null, null, null, $source, null, $app_status_id, null, null, $mode_of_receipt, null, null, null, null, null, null, null, null, null, null,0,null,null,0,0,null,null,null,null,null,1));
