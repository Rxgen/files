...
<section class="innerPage-content career-openings-container page-career-current-openings">
    ...
    <div class="open-positions__container">
        ...
        <div class="open-positions__wrapper">
            ...
            <div class="open-position">
                ...
                <div class="open-position__details">
                    ...
                    <div class="open-position__detail_info location">
                     ...
                     @if(!empty($job->mail_receipent))
                    <div class="open-position__detail_info apply">Apply with detailed CV, mentioning the post applied for in the subject line to <a class="open-position__detail_info_link" href="mailto:{{$job->mail_receipent}}">{{$job->mail_receipent}}</a></div>
                    @else
            ...
            @else
            <div class="open-position-info">
                <div class="open-position__title">No jobs found.<br>
                Apply at <a href="mailto:aspire@nayaraenergy.com">aspire@nayaraenergy.com</a>
                </div>
            </div>
            @endif
        </div>
