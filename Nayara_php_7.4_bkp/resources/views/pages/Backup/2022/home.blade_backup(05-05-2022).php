...
@section('content')
 <?php
    //commenting the banner section as per priyank till the 2022 videos
    /*   
	<section class="home-banner">
            ...
            <div class="home-banner-wrapper">
                <div class="banner-counter">
                    ...
                    <div class="banner-timeline-text courageous">
                        <div class="banner-timeline-text__alpha">
                            <div class="banner-timeline-text__prefix">Here to be</div>
                            <div class="banner-timeline-text__alphabet">C<span class="banner-timeline-text__word">ourageous</span></div>
                            <div class="banner-timeline-text__suffix">In the new era of energy</div>
                        </div>
                    </div>
            ...
            @else
            {{-- <svg class="banner-timeline-container" viewBox="0 0 800 800" hidden>
                <path id="banner-timeline" fill-rule="evenodd"  stroke-width="1px" stroke="rgb(255, 255, 255)" fill-opacity="0" opacity="0.55" fill="rgb(0, 0, 0)" d="M400.000,3.500 C618.981,3.500 796.500,181.019 796.500,400.000 C796.500,618.981 618.981,796.500 400.000,796.500 C181.019,796.500 3.500,618.981 3.500,400.000 C3.500,181.019 181.019,3.500 400.000,3.500 Z" />
            </svg> --}}
            <div class="homeBannerSliderWrapper">
                <div class="homeBannerSlider">
                    ...
                    @php 
                    $video = json_decode($top_banner->video); 
                    $mobile_video = json_decode($top_banner->mobile_video)
                    @endphp
                    ...
                    <div class="homeBannerSlides">
                        <a href="javascript:;">
                            <video class="hmslide_bannerVideo" autoplay muted loop poster="{{ $isMob ? Voyager::image($top_banner->mobile_image) : Voyager::image($top_banner->desktop_image) }}">
                                <!-- Default desktop video -->
                                @if($isMob)
                                <source src="{{url(Storage::url($mobile_video[0]->download_link))}}" type="video/mp4">
                                @else
...
{{--    <style>
	...
	.top-slider .generic-img-slider .slick-dots{
		left: 7.90629575403vw;
		right:auto;
	}
	.top-slider-wrap{
		max-height: 100vh;
	...
	.top-slider figure:not(:first-of-type) {
		display: none;
	}
	.top-slider.slick-initialized figure:not(:first-of-type) {
		display:block;
	} 
	.top-slider .top-slider-content:not(:first-of-type) {
		display: none;
	}
	.top-slider.slick-initialized .top-slider-content:not(:first-of-type) {
		display:block;
	} 
	</style>
	<section class="home-refinery top-slider-wrap">
	   <div class="generic-img-slider top-slider">
 		  <figure class="generic-img-slide">
             <img src="https://www.nayaraenergy.com/storage/home-banner/v2/Banner_2Website_new.png" class="generic-img desktop" alt="" title="" />
             <img src="https://www.nayaraenergy.com/storage/home-banner/v2/Nayara_mobile-cover.png" class="generic-img mobile" alt="" title="" />
          </figure>
		  <figure class="generic-img-slide">
			 <img src="https://www.nayaraenergy.com/storage/home-banner/v2/home_banner1.png" class="generic-img desktop" alt="" title="" />
			 <img src="https://www.nayaraenergy.com/storage/home-banner/v2/home_banner_mob1.png" class="generic-img mobile" alt="" title="" />
			 <div class="generic-slider-content top-slider-content">
				<h4 class="generic-slider-heading">
				   <span class="theme-gradient-alpha gradient-text generic-slider-text theme-gradient-mid">The Annual Report<br /> 2018-19</span><br />
				   is our success story
				</h4>
				<a class="cta gradient-cta theme-gradient top-slider-cta" href="https://www.nayaraenergy.com/annualreport2018-19/" target="_blank">
				<span class="gradient-cta-overlay gradient-text theme-gradient " style="">KNOW MORE</span>
				</a>
			 </div>
		  </figure>
		  <figure class="generic-img-slide">
			 <img src="https://www.nayaraenergy.com/storage/home-banner/v2/home_banner2.png" class="generic-img desktop" alt="" title="" />
			 <img src="https://www.nayaraenergy.com/storage/home-banner/v2/home_banner_mob2.png" class="generic-img mobile" alt="" title="" />
			 <div class="generic-slider-content top-slider-content">
				<h4 class="generic-slider-heading">
				   <span class="theme-gradient-alpha gradient-text generic-slider-text theme-gradient-mid">Dedicated to<br> sustainable </span><br /> development 
				</h4>
				<a class="cta gradient-cta theme-gradient top-slider-cta" href="https://www.nayaraenergy.com/sustainable-development" target="_blank">
				<span class="gradient-cta-overlay gradient-text theme-gradient">KNOW MORE</span>
				</a>
			 </div>
		  </figure>
		  <figure class="generic-img-slide">
			 <img src="https://www.nayaraenergy.com/storage/home-banner/v2/home_banner3.png" class="generic-img desktop" alt="" title="" />
			 <img src="https://www.nayaraenergy.com/storage/home-banner/v2/home_banner_mob3.png" class="generic-img mobile" alt="" title="" />
			 <div class="generic-slider-content top-slider-content">
				<h4 class="generic-slider-heading">
				   <span class="theme-gradient-alpha gradient-text generic-slider-text theme-gradient-mid">Start your<br />  petrol pump franchise </span><br /> in 3 easy steps 
				</h4>
				<a class="cta gradient-cta theme-gradient top-slider-cta" href="https://www.nayaraenergy.com/retail/steps" target="_blank">
				<span class="gradient-cta-overlay gradient-text theme-gradient ">KNOW MORE</span>
				</a>
			 </div>
		  </figure>
        ...
        <div class="generic-slider-content">
            ...
            <a href="{{url('/refinery')}}" class="cta gradient-cta theme-gradient">
