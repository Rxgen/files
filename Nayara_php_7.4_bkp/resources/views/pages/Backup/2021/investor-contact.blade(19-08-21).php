...
<section class="innerPage-content investorPages-container page-investors-notices">
    ...
    <div class="notices-container">
        ...
        <div class="notices-wrapper">
            <h5 class="notices-heading">Annual Return FY 2019-20 <div class="arrow-title"></div></h5>
            <div class="all-reports-listingBlock notice-lisitingBlock wrap-clear">
                <div class="pdfDownload-data">
                    <img src="https://www.nayaraenergy.com/storage/pages/May2019/pdf-img.png" alt="pdf" class="pdfIcon">
                    <div class="pdfdata-block">
                ...
                {{-- <div class="pdfDownload-data">
                    ...
                    <div class="pdfdata-block">
                        <div class="pdf-name-title">
                            Annual Return FY 2018-19 of Vadinar Oil Terminal Limited                                   </div>
                        <a href="https://www.nayaraenergy.com/storage/pages/VOTL Annual Return - 2018-19.pdf" class="cta gradient-cta theme-gradient form-cta steps-form-cta" download>
                            <span class="gradient-cta-overlay gradient-text theme-gradient">Download</span>
                        </a>
                    </div>
                </div> --}}
		...
		<div class="notices-wrapper">
            ...
            <div class="all-reports-listingBlock notice-lisitingBlock wrap-clear">
                <div class="pdfDownload-data">
                    ...
                    <div class="pdfdata-block">
                        <div class="pdf-name-title">
                        Code of Conduct, Practices and Procedures for Prevention of Insider Trading and Fair Disclosures                             
						</div>
                        <a href="https://www.nayaraenergy.com/storage/pages/August2021/Code%20of%20Conduct,%20Practices%20and%20Procedures%20for%20Prevention%20of%20Insider%20Trading%20and%20Fair%20Disclosures%20(1).pdf" class="cta gradient-cta theme-gradient form-cta steps-form-cta" target="_blank">
						<span class="gradient-cta-overlay gradient-text theme-gradient">View</span>
                        </a>
                    </div>                    
                </div>
