...
{{--<div class="innerPage-content committee-page board-members">
    ...
    @if($senior_team->order == 1 or $senior_team->order == 2)
    
        
            <div class="board_person_blk_big" data-order="{{$senior_team->order}}">
    ...
    @else
        ...
        @endif
            ...
            <div class="board_person_blk" data-order="{{$senior_team->order}}">
                <div class="board_person_blk_inner" data-index="{{$counter}}">
                    <div class="board_person_img_blk">
                        <img src="{{Voyager::image($senior_team->image)}}" alt=" {{ $senior_team->name }}">
                    </div>
...
<!--New Design Added as per the Client requiremnet for Senior management page -->

<div class="franchise-eligibilty-blk franchise-container retail-inquiry-wrapper">
    <h3 class="sustainable-title">Senior Management</h3>
