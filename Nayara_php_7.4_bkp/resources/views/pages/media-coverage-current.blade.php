...
<section class="innerPage-content investorPages-container page-investors-notices">
    <h4 class="investor-pagesTitle theme-gradient-alpha gradient-text">Media Coverage - {{$current[0]->year}}</h4>

    <div class="notices-container">
        <div class="all-reports-listingBlock notice-lisitingBlock media_cover_cur_year_listingblk wrap-clear" style="display: flex;">
