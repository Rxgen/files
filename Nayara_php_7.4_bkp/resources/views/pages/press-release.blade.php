...
<section class="innerPage-content investorPages-container page-investors-notices">
    ...
    <div class="notices-container">
        ...
        <div id="news_section"  class="all-reports-listingBlock mediaPage-container  wrap-clear">
            ...
            <div class="pdfDownload-data">
                ...
                <div class="pdfdata-block">
                    ...
                    <img src="{{ Voyager::image($release->image)}}" alt="{{ $release->image_alt}}" title="{{ $release->image_title }}" class="news-image">
