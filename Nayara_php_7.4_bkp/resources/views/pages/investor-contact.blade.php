...
<section class="innerPage-content investorPages-container page-investors-notices">
    ...
    <div class="notices-container">
        <div class="notices-wrapper active">
            ...
            <div class="all-reports-listingBlock notice-lisitingBlock wrap-clear">
                <div class="panTitle-heading">
                   <span>CIN: U11100GJ1989PLC032116</span><br><br>
                ...
                <div class="investor-contactContent-block">
                    ...
                    <div class="investor-small-para">Name : Mr. Rajeev Agrawal : Jt. General Manager - Secretarial</div>
                    <div class="investorContact-detailContainer wrap-clear">
                        <div class="investorAddress-block">
            ...
            <div class="all-reports-listingBlock notice-lisitingBlock wrap-clear">
                ...
                <div class="pdfDownload-data">
                    ...
                    <div class="pdfdata-block">
                        ...
                        Annual Return of Coviva Energy Terminals Limited for FY 2021-22.                          </div>
                        <a href="https://www.nayaraenergy.com/storage/pdf/Annual-Return-Coviva-Energy-Terminals-Limited-FY-2021-22.pdf" class="cta gradient-cta theme-gradient form-cta steps-form-cta" download>
                            <span class="gradient-cta-overlay gradient-text theme-gradient">Download</span>
                        </a>
                    </div>
                </div>
				...
				<div class="pdfDownload-data">
                    ...
                    <div class="pdfdata-block">
                        <div class="pdf-name-title">
                        <span>FY 2020-21</span>
                        Annual Return of Coviva Energy Terminals Limited – FY 2020-21                          </div>
                        <a href="https://www.nayaraenergy.com/storage/pages/May2022/Annual%20Return%20of%20Coviva%20Energy%20Terminals%20Limited%20%E2%80%93%20FY%202020-21.pdf" class="cta gradient-cta theme-gradient form-cta steps-form-cta" download>
                            <span class="gradient-cta-overlay gradient-text theme-gradient">Download</span>
                        </a>
                    </div>
                </div>
                <div class="pdfDownload-data">
                    ...
                    <div class="pdfdata-block">
                        <div class="pdf-name-title">
                        <span>FY 2021-22</span>
                        Draft Annual Return of Nayara Energy Limited – FY 2021-22                        </div>
                        <a href="https://www.nayaraenergy.com/storage/pages/September2022/Draft%20Annual%20Return%20Nayara%20Energy-%202021-22.pdf" class="cta gradient-cta theme-gradient form-cta steps-form-cta" download>
                            <span class="gradient-cta-overlay gradient-text theme-gradient">Download</span>
                        </a>
                    </div>
                </div>
        ...
        <div class="notices-wrapper">
            <h5 class="notices-heading">Archival Policy for disclosure of material events on website<div class="arrow-title"></div></h5>
            <div class="all-reports-listingBlock notice-lisitingBlock wrap-clear">
                <div class="pdfDownload-data">
                    <img src="https://www.nayaraenergy.com/storage/pages/May2019/pdf-img.png" alt="pdf" class="pdfIcon">
                    <div class="pdfdata-block">
                        <div class="pdf-name-title">
                        Archival Policy for disclosure of material events on website                                    </div>
                        <a href="https://www.nayaraenergy.com/storage/pages/April2022/Archival%20Policy%20for%20disclosure%20of%20material%20events%20on%20website.pdf" class="cta gradient-cta theme-gradient form-cta steps-form-cta" target="_blank">
                            <span class="gradient-cta-overlay gradient-text theme-gradient">View</span>
                        </a>
                    </div>                    
                </div>
        ...
        <div class="notices-wrapper">
            <h5 class="notices-heading">Familiarisation Program for Independent Directors<div class="arrow-title"></div></h5>
            <div class="all-reports-listingBlock notice-lisitingBlock wrap-clear">
                <div class="pdfDownload-data">
                    <img src="https://www.nayaraenergy.com/storage/pages/May2019/pdf-img.png" alt="pdf" class="pdfIcon">
                    <div class="pdfdata-block">
                        <div class="pdf-name-title">
                        Familiarisation Program for Independent Directors                                    </div>
                        <a href="https://www.nayaraenergy.com/storage/pages/April2022/Nayara%20-%20Familiarisation%20Program.pdf" class="cta gradient-cta theme-gradient form-cta steps-form-cta" target="_blank">
                            <span class="gradient-cta-overlay gradient-text theme-gradient">View</span>
                        </a>
                    </div>                    
                </div>
        ...
        <div class="notices-wrapper">
            <h5 class="notices-heading">Criteria for payment of remuneration to Non-Executive Directors<div class="arrow-title"></div></h5>
            <div class="all-reports-listingBlock notice-lisitingBlock wrap-clear">
                <div class="pdfDownload-data">
                    <img src="https://www.nayaraenergy.com/storage/pages/May2019/pdf-img.png" alt="pdf" class="pdfIcon">
                    <div class="pdfdata-block">
                        <div class="pdf-name-title">
                        Criteria for payment of remuneration to Non-Executive Directors                                    </div>
                        <a href="https://www.nayaraenergy.com/storage/pages/April2022/Criteria%20for%20payment%20of%20remuneration%20to%20NEDs.pdf" class="cta gradient-cta theme-gradient form-cta steps-form-cta" target="_blank">
                            <span class="gradient-cta-overlay gradient-text theme-gradient">View</span>
                        </a>
                    </div>                    
                </div>
        ...
        <div class="notices-wrapper">
            <h5 class="notices-heading">Policy for determining material subsidiary(ies)<div class="arrow-title"></div></h5>
            <div class="all-reports-listingBlock notice-lisitingBlock wrap-clear">
                <div class="pdfDownload-data">
                    <img src="https://www.nayaraenergy.com/storage/pages/May2019/pdf-img.png" alt="pdf" class="pdfIcon">
                    <div class="pdfdata-block">
                        <div class="pdf-name-title">
                        Policy for determining material subsidiary(ies)                                    </div>
                        <a href="https://www.nayaraenergy.com/storage/pages/May%202022/Nayara%20Material%20Subsidiary%20Policy.pdf" class="cta gradient-cta theme-gradient form-cta steps-form-cta" target="_blank">
                            <span class="gradient-cta-overlay gradient-text theme-gradient">View</span>
                        </a>
                    </div>                    
                </div>
