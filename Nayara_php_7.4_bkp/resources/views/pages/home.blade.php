...
{{-- <div class="banner-iframe-container">
    <a href="https://www.youtube.com/embed/PrGxSOi5r28?autoplay=1" target="_blank" >
    <img class="banner-image" src="{{asset('images/v2/New-Nayara-Thumbnail-video-banner.jpg')}}" alt="Banner Image"    onclick="playVideo()">
        <iframe  class="banner-iframe"  src="https://www.youtube.com/embed/PrGxSOi5r28?autoplay=1" frameborder="0" allow="accelerometer; autoplay; encrypted-media;"></iframe>
    </a>
</div>--}}
...
<?php
    ...
    <section class="home-banner">
            ...
            <div class="homeBannerSliderWrapper">
                <div class="homeBannerSlider">
                    ...
                    <div class="generic-img-slider">
                        ...
                        @foreach($top_banners as $top_banner)
                            <img src="{{Voyager::image($top_banner->desktop_image)}}" class="generic-img desktop"/>
                            <!-- <img src="{{Voyager::image($top_banner->mobile_image)}}" class="generic-img mobile"/> -->
                            @endforeach
                        </figure>
        ...
        @foreach($top_banners as $top_banner)
            <a href="{{$top_banner->cta}}">
            <figure class="generic-img-slide">
            
                <img src="{{Voyager::image($top_banner->desktop_image)}}" class="generic-img desktop" alt="{{$top_banner->image_alt}}" title="title" />
                <img src="{{Voyager::image($top_banner->mobile_image)}}" class="generic-img mobile" alt="{{$top_banner->image_alt}}" title="title" />
