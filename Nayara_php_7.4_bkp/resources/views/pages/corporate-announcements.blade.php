...
<section class="innerPage-banner-container">
    <picture>
        ...
        <img src="{{Voyager::image($page[0]->desktop_banner)}}" alt="Corporate Announcement" title="Corporate Announcement" class="innerBanner-img">
    </picture>
            ...
            @endphp
                            <tbody>
                                <tr class="yellowbg">
                                    ...
                                    {{ \Carbon\Carbon::createFromFormat('Y-m-d' , $report->date)->format('F d, Y') }}
