...
<input value="{{route('retail.thankyou')}}" type="hidden" class="thanku-redirect" />
...
<input value="{{route('populate_states')}}" type="hidden" class="states_url" />
<input value="{{route('dealership.thankyou')}}" type="hidden" class="thanku-redirect" />
<input value="{{route('populate_district')}}" type="hidden" class="district_url" />
<input value="{{route('dealership.form_url')}}" type="hidden" class="apply_form_submit" />
@endif
@if (collect(request()->segments())->last() === 'petrol-pump-near-me')
<input value="{{route('get.ro')}}" type="hidden" class="find-ro-url" />
<input value="{{route('get.code-ro')}}" type="hidden" class="ro-code-url" />
<input value="{{route('get.ro.radius')}}" type="hidden" class="ro-code-radius" />
@endif
@if (collect(request()->segments())->last() === 'petrol-pump-near-me')
<input value="{{route('get.ro')}}" type="hidden" class="find-ro-url" />
...
@if(count($page) > 0)
    ...
    <section class="innerPage-content retail-content retail-apply">
        <div class="retail-inquiry-wrapper" id="contact-enquiry"><h2 class="innerPageTitle theme-gradient-alpha gradient-text">Retail Outlet Franchisee Enquiry</h2>
            <div class="retail-inquiry-container wrap-clear"style="align-items:center"; >
                <div class="retail-inquiry__contact-container">
                    <div class="retail-inquiry__contact"><img src="https://www.nayaraenergy.com/storage/pages/April2019/contact-phone-icon2.png" alt="" width="80" height="32" /> <span class="retail-inquiry__contact_prefix">Toll Free Number</span> <a class="retail-inquiry__contact_number" href="tel:18001200330">1800 1200 330</a>
				...
				<div class="retail-inquiry__contact-form">
					...
					<label id="mobileError" class="text-danger"></label>
					...
					<label class="retail-inquiry__contact-form_wrapper select required">
					  <select id="source" class="retail-inquiry__contact-form_input">
						 ...
						 <option value="Online/Digital Ads">Online/Digital Ads</option>
						 <option value="Press Release/Newspaper Ad">Press Release/Newspaper Ad</option>
					...
					<label class="retail-inquiry__contact-form_wrapper required captcha_wrap" style="">
					...
					<label class="retail-inquiry__contact-form_wrapper" style="width: 10;display: inline-block;/* height: auto; */padding: 0px;border-bottom: 0px;"> = </label>
					<label class="retail-inquiry__contact-form_wrapper answer_wrap" style="">
					<input id="captcha" type="number" class="retail-inquiry__contact-form_input" style="/* display:inline-block; *//* width: 40%; */" placeholder="enter answer">
					</label>
		...
		<ul class="bullet-list">
			<li>You can start petrol pump on owned or leased land .</li>
			<li>**Varies from location to location as per norms.</li>
			<li>Minimum 1.5* + Crores Investment.</li>
		</ul>
	</div>
    </section>
    @elseif(collect(request()->segments())->last() === 'apply-online-for-dealership')
        ...
        <div class="retail-inquiry-wrapper"><strong class="innerPageTitle theme-gradient-alpha gradient-text">Retail Outlet Franchisee Enquiry</strong>
            <div class="retail-inquiry-container wrap-clear">
                <div class="retail-inquiry__contact-container">
                    ...
                    <div class="retail-inquiry__contact"><img src="https://www.nayaraenergy.com/storage/pages/April2019/contact-phone-icon2.png" alt="" width="80" height="32" /> <span class="retail-inquiry__contact_prefix">Or give a missed call at</span> <a class="retail-inquiry__contact_number" href="tel:18001200330">09575795330</a></div>
                </div>
				<div class="retail-inquiry__contact-form">
					<label class="retail-inquiry__contact-form_wrapper required" for="name">
					<input id="name" type="text" class="retail-inquiry__contact-form_input" placeholder="Name"> </label>
					...
					<button class="cta gradient-cta theme-gradient form-cta retail-form-cta"> <span class="gradient-cta-overlay gradient-text theme-gradient">Submit</span> </button>
					<div class="form-thank-you">Request registered Successfully.
                      <br>You will soon receive a call from our customer care executive
                    </div>
				</div>
            </div>
        </div>
