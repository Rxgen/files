...
{{--<div style="clear:both;width:100%">
    ...
    @if(count($in_the_news) > 0)
		<h4 id="news_year" class="investor-pagesTitle theme-gradient-alpha gradient-text" style="float:left;"> Newsroom </h4>
    <div class="notices-container" style="clear: both">
        <div id="news_section" class="all-reports-listingBlock notice-lisitingBlock media_cover_cur_year_listingblk wrap-clear in-the-news">
            ...
            <div class="pdfDownload-data">
                ...
                <div class="pdfdata-block">
                    <a href=" {{ $news->news_link }}"><img src="{{ Voyager::image($news->image) }}" alt="{{ $news->img_alt }}" title="{{ $news->img_title }}" class="news-image"></a>
