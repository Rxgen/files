            ...
            <div class="modal-content">
                ...
                <form action="" id="m_form" method="POST"
                    ...
                    <div class="modal-body">
                        ...
                        <input type="text" class="form-control" id="m_content" name="content" placeholder=" Content"><br>

                        <label for="description">Description</label>
                        <input type="text" class="form-control" id="m_desc" name="description" placeholder=" description"><br>

                        <label for="Image">HomePage Image</label>
                        <input type="text" class="form-control" id="m_image" name="image" placeholder="Image"><br>


                        {{-- <br>Active &nbsp;
                        <label class="custom-toggle-switch">
                          <input type="checkbox" class="custom-toggle-switch-checkbox" name="status" checked>
                          <span class="custom-toggle-switch-slider round-switch-slider"></span>
                        </label> --}}
        ...
        $(document).ready(function () {
            ...
            $m_modal.on('show.bs.modal', function(e, data) {
                ...
                if (_adding) {
                    ...
                    $m_id.val(id);
                    $m_content.val(_src.data('m_content'));
                    $m_desc.val(_src.data('m_desc'));
                    $m_image.val(_src.data('m_image'));
