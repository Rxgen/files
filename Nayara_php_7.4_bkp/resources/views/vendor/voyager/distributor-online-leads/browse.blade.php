...
@section('page_header')
    <div class="container-fluid">
        ...
        <form action="{{route('export.leads','DistributorOnlineLead')}}" method="post" class="btn">
            {{csrf_field()}}
            {{method_field('POST')}}
            From Date<input type="date" name="from_date" class="">
            To Date<input type="date" name="to_date" class="">
            <button class="btn btn-info btn-lg" style="margin-top:0;" type="submit">Export </button>             
        </form>
    </div>
