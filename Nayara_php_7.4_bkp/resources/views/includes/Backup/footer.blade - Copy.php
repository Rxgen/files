<footer class="footerContainer">
    <div class="footerSocialIconsContainer">
        ...
        <a href="{{setting('site.twitter_social_media_icon_mp')}}" target="_blank" rel="noopener noreferrer" class="socialIconBox">
...
<div class="popUp" style = "display:none!important">
    <p>We would like to inform that as per the Hon’ble Supreme Court of India’s judgment dated 4 November 2022 in the matter of Employees’ Provident Fund Organisation & Another v. Sunil Kumar & Others [Special Leave Petition (C) 8658-8659 of 2019], certain category of employees/ ex-employees are entitled to opt for higher pension benefits under Employees’ Pension Scheme 1995.</p>
    <a href="{{url('investors/employees-pension-scheme')}}" target="_blank">To know more click here</a>
