...
// $navfuel.on('click', function () {
    ...
    window.__vars.$body.on('click', function () {
        ...
        $nav_search.removeClass('active');
        $('.header_form').removeClass("marginTop78");
        $('.bottomHead').removeClass("marginTop175");
        $nav_searchBlk.removeClass('active');
        $('.mobile__landscape').removeClass('landscape_hide');
        $('.headLink').removeClass('marginRight');
        $('.nav_search').removeClass("activate");
        $('.header_form').removeClass("searchActivate");
    });
    //search
    ...
    $nav_search.hover( function () {
        $('.header_form').addClass("searchActivate");
        $('.autocomplete-suggestions').css('opacity', '1');
    });
    
    $('.header_form').on('mouseleave',function(e){
        $('.header_form').removeClass("searchActivate");
...
$(document).ready(function() {
    ...
    $('.hasSubmenu-I>a').click(function (e) { 
        ...
        e.preventDefault();
        $('.hasSubmenu-I>a').removeClass('active');
        $('.hasSubmenu-II>a').addClass('active');
        $('.hasSubmenu-III>a').addClass('active');
        $(this).addClass('active');
        $('.heroWrapper').removeClass('heroHide');
    ...
    $('.readMore').click(function (e) {
        e.preventDefault();
        e.stopPropagation();
        $('.institute_content,.more,.less').toggleClass('active');
    })  

    $('.video-poster').click(function (e) {
        e.preventDefault();
        $(this).hide();
        $('#nayaraVideo')[0].play();
    })
    ...
    $(document).ready(function() {
        ...
        var suggestionsContainer = $('<div class="autocomplete-suggestions"></div>').insertAfter(searchInput);
