        ...
        result_slider += '<div class="locate-a-pump__slide">'+
                               ...
                               '<div class="locate-a-pump__slide_address_container">'+
                                   ...
                                   '<div class="locate-a-pump__slide_prices_container">'+
                                       '<div class="locate-a-pump__slide_price_container">'+
                                           '<h6 class="locate-a-pump__slide_price_title">'+value.fuel_type+' / ltr</h6>'+
                                           '<i class="fa fa-inr"></i>'+parseFloat(value.price).toFixed(2)+
                                       '</div>'+
                                   '</div>'+
    ...
    $.ajax({
      ...
      success: function(data){
        ...
        if(data == 0){
          ...
          result_slider += '<div class="locate-a-pump__slide">'+
                               '<h5 class="locate-a-pump__slide_title theme-gradient">'+value.address1+'</h5>'+
                               '<div class="locate-a-pump__slide_address_container">'+
                                   '<address class="locate-a-pump__slide_address">'+value.address+'</address>'+
                                   '<div class="locate-a-pump__slide_prices_container">'+
                                       '<div class="locate-a-pump__slide_price_container">'+
